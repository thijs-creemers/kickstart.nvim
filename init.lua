...
require('lazy').setup({
  ...
  "MunifTanjim/nui.nvim", -- for floating windows (optional)
...
local servers = {
  ...
  lua_ls = {
    Lua = {
      ...
      hint = { enable = true },
      -- 👇 This disables annoying type warnings for plugin configs
      completion = {
        callSnippet = "Replace",
      },
    },
    -- add other servers like clangd, gopls, etc.
  },
}
...
-- Setup handlers if supported (only in mason-lspconfig >= 1.3)
...
if mason_lspconfig.setup_handlers then
  ...
  -- Fallback: manually loop over servers
...
parser_config.clojure = {
  ...
  filetype = "bb", "clj", "cljs" -- if filetype does not match the parser name
}
