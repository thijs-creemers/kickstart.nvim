...
vim.keymap.set('n', '<leader>ap', function()
  ...
  vim.fn.system { 'asciidoctor', file }
  vim.fn.jobstart({ 'open', output }, { detach = true }) -- use xdg-open or start on Linux/Windows
end, { desc = 'Build and open AsciiDoc preview' })
...
require('lazy').setup({
  ...
  -- NOTE: Plugins can specify dependencies.
  {
    ...
    config = function()
      ...
      -- Setup mason-nvim-dap to ensure debug adapters are installed
      require('mason-nvim-dap').setup {
        ensure_installed = { 'python', 'go', 'node2', 'clojure' }, -- Add adapters for your languages
        handlers = {},
      }
  ...
  },
  {
    ...
    config = function()
      require('chatgpt').setup {
        -- IMPORTANT: Set up your API key, preferably via an environment variable
        -- or a command like the one below to avoid committing secrets.
        api_key_cmd = 'echo $OPENAI_API_KEY',
        -- Add custom actions that can act as agentic commands
        actions_paths = {
          -- You can add paths to custom action files here
        },
      }
    end,
  },
  ...
  {
    'Olical/conjure',
    -- Lazy-load on Clojure filetypes
    ft = { 'clojure', 'fennel', 'janet' },
    -- Optional: customize mappings or behavior
    config = function()
      -- Example: Change the prefix for Conjure mappings
  ...
  --  Use ALT-shift with H,J,K and L for slupr and barf actions
  --  (      )
  -- H J    K L
  --
  {
...
-- Set up markdown fenced languages
